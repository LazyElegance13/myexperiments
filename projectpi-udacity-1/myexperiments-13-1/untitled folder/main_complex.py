...
<body="get">
    ...
    <br>
    <input type="submit" label="form" value="1">
    <input type="submit" label="rot13" value="2">
    Coming Soon<input type="submit" label="Coming Soon" value="3">
</body>
"""
...
class MainHandler(webapp2.RequestHandler):
    ...
    def post(self):
        ...
        if value == '1':
            ...
            self.write_form("Sorry, Wrong Input")
